        ...
        if (
          ((0, n.useEffect)(() => {
            let e = () => {
              ...
              e > 1400
                ? (r(12),
                  i('$SCAT contract address'),
                  o('contract address $SCAT'))
              ...
              (0, s.jsxs)(c, {
                ...
                children: [
                  ...
                  (0, s.jsxs)(f, {
                    position: 'right',
                    children: [
                      (0, s.jsx)(h, { children: 'Get some $BNB' }),
                      (0, s.jsxs)(u, {
                        children: [
                          'Tap the BUY button in the app to purchase',
                          ' ',
                          (0, s.jsx)('br', { className: 'hidden xl:block' }),
                          ' BNB, or deposit $BNB to your Metamask ',
                          (0, s.jsx)('br', { className: 'hidden xl:block' }),
              ...
              (0, s.jsxs)(c, {
                ...
                children: [
                  ...
                  (0, s.jsxs)(f, {
                    position: 'left',
                    children: [
                      (0, s.jsx)(h, { children: 'Swap $BNB for $SCAT' }),
                      (0, s.jsxs)(u, {
                        children: [
                          'Go to',
                          ' ',
                          (0, s.jsx)('span', {
                            ...
                            children: (0, s.jsx)('a', {
                              href: a,
                              target: '_blank',
                              children: 'Uniswap.org',
                            }),
                          }),
                          ' ',
                          'and swap $BNB for $SCAT',
                          (0, s.jsx)('br', {}),
                          (0, s.jsxs)(l.J2, {
                            open: i,
                            onOpenChange: d,
